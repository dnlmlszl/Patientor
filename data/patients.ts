import { PatientEntry, Gender, RawEntry } from '../types';
import { toNewPatientEntry } from '../utils';

const data: (PatientEntry & { entries: RawEntry[] })[] = [
  {
...
const patientEntries: PatientEntry[] = data.map((obj) => {
  const newPatientEntry = toNewPatientEntry(obj) as PatientEntry;
  newPatientEntry.id = obj.id;
